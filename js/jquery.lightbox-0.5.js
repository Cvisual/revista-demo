...
(function($) {
	...
	$.fn.lightBox = function(settings) {
		...
		settings = jQuery.extend({
			...
			imageBtnPrev:			'images/flacha_izq.png',			// (string) Path and the name of the prev button image
			imageBtnNext:			'images/flacha_dxa.png',			// (string) Path and the name of the next button image
			imageBtnClose:			'images/cruz.png',		// (string) Path and the name of the close btn
